...
rsync -auzv -e "ssh -p 60022" ec2-user@swest.toppers.jp:/var/www/html/SWEST22/lecture program-data/SWEST22/
rsync -auzv -e "ssh -p 60022" ec2-user@swest.toppers.jp:/var/www/html/SWEST23/lecture program-data/SWEST23/
yarn gulp pre
